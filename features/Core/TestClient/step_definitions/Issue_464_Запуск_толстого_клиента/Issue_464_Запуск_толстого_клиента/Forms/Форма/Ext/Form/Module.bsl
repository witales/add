...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧДанныеКлиентовТестированияVanessaBehavoirСодержитсяСтрока(ТабПарам)","ВТЧДанныеКлиентовТестированияVanessaBehavoirСодержитсяСтрока","И     в ТЧ ДанныеКлиентовТестирования VanessaBehavoir содержится строка:");
...
&НаКлиенте
//И     в ТЧ ДанныеКлиентовТестирования VanessaBehavoir содержится строка:
//@ВТЧДанныеКлиентовТестированияVanessaBehavoirСодержитсяСтрока(ТабПарам)
Процедура ВТЧДанныеКлиентовТестированияVanessaBehavoirСодержитсяСтрока(ТабПарам) Экспорт
