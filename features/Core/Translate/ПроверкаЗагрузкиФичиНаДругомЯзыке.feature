...
Чтобы я мог её выполнить на библиотеке стандартных шагов не переключая язык в настройках

Контекст: 
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий с закрытием всех окон кроме "* autotest: Vanessa Behavior"
